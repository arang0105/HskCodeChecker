...
with st.sidebar:
    ...
    #
    # 셋째 줄은 **안심시키는 쪽**의 고지다. 사용자가 가장 꺼리는 건 자기
    # 제품 도면이 남는 것인데, 실제로 안 남는데도 그 말을 안 하고 있었다.
    # 앞 두 줄과 달리 이건 경고가 아니라 사실 안내라 굵게만 두고 끝낸다.
    st.markdown(
        "<div style='text-align:center; font-size:0.9em;'><b>"
        "입력한 내용과 결과가 저장됩니다.<br>개선 목적으로만 사용합니다.<br>"
        "올린 카탈로그 파일은 저장하지 않습니다."
        "</b></div>",
